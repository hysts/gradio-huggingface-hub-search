...
def test_select_result_from_dropdown(page: Page) -> None:
...
def test_select_result_with_keyboard(page: Page) -> None:
...
def test_enter_submits_raw_text_when_dropdown_closed(page: Page) -> None:
...
def test_clear_button_appears_on_input(page: Page) -> None:
...
def test_clear_button_resets_input(page: Page) -> None:
...
def test_clear_button_visible_after_select(page: Page) -> None:
...
def test_dropdown_opens_on_typing(page: Page) -> None:
...
def test_dropdown_closes_on_escape(page: Page) -> None:
...
def test_dropdown_closes_on_click_outside(page: Page) -> None:
...
def test_dropdown_closes_on_clear(page: Page) -> None:
...
def test_arrow_keys_navigate_results(page: Page) -> None:
...
def test_chips_visible_after_selecting_result(page: Page) -> None:
...
def test_chips_visible_after_clearing_selection(page: Page) -> None:
...
def test_chips_visible_after_keyboard_select(page: Page) -> None:
...
def test_chip_toggle_works_after_select(page: Page) -> None:
...
def test_dropdown_shows_category_headers(page: Page) -> None:
...
def test_single_type_search_works_without_chips(page: Page) -> None:
...
def test_multi_type_chips_survive_selection(page: Page) -> None:
...
def test_dropdown_shows_no_results_message(page: Page) -> None:
...
def test_submit_on_select_false_does_not_trigger_change(browser: Browser) -> None:
    ...
    try:
        ...
        block = get_search_block(pg, "Test Search")
        search_input = block.locator(".hf-search-input")
        dropdown = block.locator(".hf-search-dropdown")
        change_result = pg.get_by_label("Change Event Result")
...
def test_focus_reopens_dropdown_with_cached_results(page: Page) -> None:
...
def test_result_limit_caps_dropdown_items(browser: Browser) -> None:
    ...
    try:
        ...
        block = get_search_block(pg, "Limited Search")
        search_input = block.locator(".hf-search-input")
        dropdown = block.locator(".hf-search-dropdown")
...
def test_result_limit_larger_than_default_shows_more_items(browser: Browser) -> None:
    ...
    try:
        ...
        block = get_search_block(pg, "Wide Search")
        search_input = block.locator(".hf-search-input")
        dropdown = block.locator(".hf-search-dropdown")
