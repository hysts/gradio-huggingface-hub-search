...
def test_search_all_shows_five_chips(demo_url: str) -> None:
...
def test_single_type_hides_filter_chips(demo_url: str) -> None:
...
def test_multi_type_shows_three_chips(demo_url: str) -> None:
...
def test_chip_exclusive_select(demo_url: str) -> None:
...
def test_sole_active_chip_resets_all(demo_url: str) -> None:
...
def test_inactive_chip_adds_to_selection(demo_url: str) -> None:
...
def test_exclusive_chip_filters_dropdown_results(demo_url: str) -> None:
